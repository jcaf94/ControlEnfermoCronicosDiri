...
/*PROTECTED REGION ID(usingChroniGenNHibernate.CEN.Chroni_CarePlan_setEndDate) ENABLED START*/
...
{
        /*PROTECTED REGION ID(ChroniGenNHibernate.CEN.Chroni_CarePlan_setEndDate) ENABLED START*/
        ...
        if (p_oid > 0) {
                ...
                if (carePlan != null) {
                        if (p_endDate != null && p_endDate > carePlan.EndDate) {
                                carePlan.EndDate = p_endDate;
