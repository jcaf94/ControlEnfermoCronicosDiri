...
/*PROTECTED REGION ID(usingChroniGenNHibernate.CEN.Chroni_Practitioner_setAddress) ENABLED START*/
...
{
        /*PROTECTED REGION ID(ChroniGenNHibernate.CEN.Chroni_Practitioner_setAddress) ENABLED START*/
        ...
        if (p_oid > 0) {
                ...
                if (practitioner != null) {
                        if (!string.IsNullOrEmpty (p_address)) {
                                practitioner.Address = p_address;
